...
|---|---|---|---|
| Core checks | done | `conda run -n rl-infra-design-agents make check` passed with content ledger validation and 57 tests. | Keep green after every workflow or content change. |
